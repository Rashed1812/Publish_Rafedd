    ...
    public partial class CreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnualTargets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnnualTargets_AspNetUsers_ManagerUserId",
                        column: x => x.ManagerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AnnualTargets_Managers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_AspNetUsers_ManagerUserId",
                        column: x => x.ManagerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_Managers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Managers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnnualTargetId = table.Column<int>(type: "int", nullable: false),
                    Month = table.Column<int>(type: "int", nullable: false),
                    MonthlyGoal = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyPlans_AnnualTargets_AnnualTargetId",
                        column: x => x.AnnualTargetId,
                        principalTable: "AnnualTargets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeeklyCosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeeklyCosts_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekNumber = table.Column<int>(type: "int", nullable: false),
                    WeeklyGoal = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false),
                    Month = table.Column<int>(type: "int", nullable: false),
                    WeekStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WeekEndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AchievementPercentage = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskReports_Tasks_TaskItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerformanceReports_WeeklyPlans_WeeklyPlanId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-001", null, "Admin", "ADMIN" },
                    { "employee-001", null, "Employee", "EMPLOYEE" },
                    { "manager-001", null, "Manager", "MANAGER" }
                });

            migrationBuilder.InsertData(
                table: "SubscriptionPlans",
                columns: new[] { "Id", "Description", "IsActive", "MaxEmployees", "Name", "PricePerMonth" },
                values: new object[,]
                {
                    { 1, "حتى 30 موظف - جميع المميزات الأساسية", true, 30, "Basic", 50m },
                    { 2, "حتى 100 موظف - تقارير متقدمة ودعم أولوية", true, 50, "Pro", 100m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnualTargets_ManagerId",
                table: "AnnualTargets",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnnualTargets_ManagerUserId_Year",
                table: "AnnualTargets",
                columns: new[] { "ManagerUserId", "Year" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Managers_SubscriptionEndsAt",
                table: "Managers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyPlans_AnnualTargetId_Month",
                table: "MonthlyPlans",
                columns: new[] { "AnnualTargetId", "Month" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReports_WeeklyPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_ManagerId",
                table: "Subscriptions",
                column: "ManagerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskReports_TaskItemId",
                table: "TaskReports",
                column: "TaskItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_Year_Month_WeekNumber",
                table: "Tasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeeklyCosts_EmployeeId",
                table: "WeeklyCosts",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_WeeklyCosts_Status",
                table: "WeeklyCosts",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_WeeklyCosts_Year_Month_WeekNumber",
                table: "WeeklyCosts",
                columns: new[] { "Year", "Month", "WeekNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_WeeklyPlans_AchievementPercentage",
                table: "WeeklyPlans",
                column: "AchievementPercentage");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeeklyPlans_Year_Month_WeekNumber",
                table: "WeeklyPlans",
                columns: new[] { "Year", "Month", "WeekNumber" });
        }
